...
import com.duakhan.AsanZindagi.databinding.ActivityDoctorProfileBinding;
...
public class Doctor_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookingnow = view.findViewById(R.id.booking);
        ...
        bookingnow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Username != null && !Username.isEmpty()) {
                    database.getReference().child("Doctor_Appointment").child(serid).child(Date).setValue(appoint);
                   // Toast.makeText(Doctor_Profile.this, Username, Toast.LENGTH_LONG).show();


                    Toast.makeText(Doctor_Profile.this, "thank you! now you request is in processing", Toast.LENGTH_LONG).show();
...
//back activity from profile to home
    ...
    public void callusername() {
      ...
      //  Toast.makeText(Doctor_Profile.this, Uid, Toast.LENGTH_SHORT).show();
